# ⚡ ESP32 High-Pressure Aeroponics Root Chamber & VPD Controller
...
Automated aeroponic growing system pulsing 100 PSI misting solenoids with sub-second accuracy, calculating Vapor Pressure Deficit (VPD), and dosing nutrients.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-aeroponics-highpressure-controller.ino`](./esp32-aeroponics-highpressure-controller.ino).
